      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2>Update Greeting Card</h2>
            <div class="div_deg">
                <form action="{{url('edit_gcard',$data->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                    <div>
                    ...
                    <div>
                      <input type="submit" class="btn btn-success" value="Edit Accessory">
                    </div>
                </form>
            </div>
          </div>
