<nav id="sidebar">
        ...
        <ul class="list-unstyled">
                <li><a href="{{url('super/dashboard')}}"> <i class="icon-home"></i>Home </a></li>
                <li><a href="{{url('view_category_super')}}"> <i class="icon-grid"></i>Category </a></li>
                <li><a href="{{url('view_orders_super')}}"> <i class="icon-grid"></i>Orders </a></li>
                <li><a href="{{url('view_employees_super')}}"> <i class="icon-grid"></i>Employees </a></li>
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Products </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    <li><a href="{{url('add_product_super')}}">Add Product</a></li>
                    <li><a href="{{url('view_product_super')}}">View Product</a></li>
                  </ul>
                </li>
